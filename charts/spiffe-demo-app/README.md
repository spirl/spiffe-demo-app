...
| spiffeCSIDriver.image | object | `{"registry":"ghcr.io","repository":"spiffe/spiffe-csi-driver","tag":"0.2.3"}` | The SPIFFE CSI driver image. |
| spiffeCSIDriver.nodeDriverRegistrarImage | object | `{"registry":"registry.k8s.io","repository":"sig-storage/csi-node-driver-registrar","tag":"v2.6.0"}` | The node-driver-registrar sidecar image. |
