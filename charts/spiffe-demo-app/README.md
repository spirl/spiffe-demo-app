...
| podSecurity.restricted | bool | `false` | Apply the restricted-compliant securityContext blocks. OFF by default: the rendered pod is unchanged from previous chart versions. Set true for namespaces enforcing PodSecurity "restricted" (e.g. GKE Autopilot). |
